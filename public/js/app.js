...
__webpack_require__(/*! ./bootstrap */ "./resources/js/bootstrap.js"); // Menus
//=============
...
if (document.querySelectorAll('.menu-exit')) {
  document.querySelectorAll('.menu-exit').forEach(function (exit) {
...
if (document.querySelectorAll(".small-article-command")) {
  document.querySelectorAll(".small-article-command").forEach(function (command) {
...
if (document.querySelector('#closeChangeState')) {
  document.querySelector('#closeChangeState').addEventListener('click', function () {
...
if (document.querySelectorAll(".icon-edit-command")) {
  document.querySelectorAll(".icon-edit-command").forEach(function (command) {
    command.addEventListener('click', function () {
...
if (document.querySelector('#closeChangeArticle')) {
  document.querySelector('#closeChangeArticle').addEventListener('click', function () {
