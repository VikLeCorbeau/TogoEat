        ...
        <form method="POST" action="{{ route('save') }}">
            ...
            <div>
             ...
             <div>
                ...
                <!-- balise auth(admin) à implementer pour l'option gérant -->
    ...
    <div class="access-container">
        ...
        <div>
            <div class="access-part">
                ...
                <p class="access-text stl">Administrer votre restaurant et vos employés quand vous le souhaitez.</p>

                <div class="access-errors-container">
                    <x-auth-validation-errors class="access-error" :errors="$errors" />
                </div>
    
                <form method="POST" action="{{ route('save') }}" class="access-form">
                    @csrf
                    ...
                    <div class="access-buttons-container">
                        <input type="submit" class="basic-button button--dark" value="Enregistrer l'employé">
                        @if (Route::has('login'))
